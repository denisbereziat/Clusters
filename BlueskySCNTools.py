...
class BlueskySCNTools():
    ...
    def Drone2Scn(self, drone_id, start_time, lats, lons, turnbool, alts = None, turn_speeds = None):
        ...
        with open(filepath, 'w+') as f:
            ...
            for drone_id in dictionary:
                try:
                    ...
                    if "turn_speeds" in dictionary[drone_id]:
                        turn_speeds = dictionary[drone_id]["turn_speeds"]
                    else:
                        turn_speeds = None
                except:
                ...
                if turn_speeds is None:
                    ...
                    lines = self.Drone2Scn(drone_id, start_time, lats, lons, turnbool, alts, turn_speeds[drone_id])
                f.write(''.join(lines))
...
def qdrdist(latd1, lond1, latd2, lond2, mode):
    """ Calculate bearing and distance, using WGS'84
        In:
            latd1,lond1 en latd2, lond2 [deg] :positions 1 & 2
        Out:
